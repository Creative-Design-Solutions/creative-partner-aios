# Creative Partner AIOS

A personal AI operating system built for people with vision — those who feel the creative spark within them and want a partner to help make it real, structured, and lasting.

This isn't a productivity tool. It's a growing partnership that evolves with you.
...
references/
  creative-partner-aios.md  ← The soul of this system
...
workflows/
  ...
  agent-build.md            ← Building new tools and agents
  agent-design.md           ← Design and visual work
  agent-ops.md              ← Operations and admin
  onboard-invoice-client.md ← Set up a client's invoice generator

billing/
  invoice-generator.html    ← CDS branded invoice generator
...
tools/                      ← Scripts for connecting to external services
```
...
| 7 | Run `/level-up` — find your first automation |

---

## Skills at a glance

Type any of these to activate:
...
| `/snag` | Search before debugging |
| `/design-master` | Full creative design session |
| `/designer` | Brand, logos, image generation |
| `/level-up` | Weekly growth ritual |

See `references/skills-guide.md` for the full list.

---

## Philosophy

Read `references/creative-partner-aios.md` when you have five minutes. It's short. It's the reason this system exists and the reason it works differently than anything else you've tried.

---

*Built by Creative Design SOULutions · creativedesignsoulutions.com*
