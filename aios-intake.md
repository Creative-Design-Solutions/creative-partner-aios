...
An email, a message, a post, a note to yourself — anything that sounds like you when you're not trying. **Paste verbatim.** Don't write these now — pull something you already wrote.
...
The thing you dread, keep putting off, or do manually when you know you shouldn't. Plus where tasks and projects live — or where you wish they did.

```
[Your biggest time drain and your current (or ideal) task system]
```
